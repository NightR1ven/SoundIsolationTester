...
# -*- coding: utf-8 -*-
"""
Генератор тестового датасета для тестовой работы
...
class TestDatasetGenerator:
    ...
    def _get_default_speech_samples(self) -> List[str]:
        ...
        return [
            ...
            "Защита работы состоится в июне сорок пять",
...
def create_diploma_dataset():
    """Создать предопределенный датасет для тестовой работы"""
    ...
    print(f"\n🎓 ДАТАСЕТ ДЛЯ ТЕСТОВОЙ РАБОТЫ СОЗДАН!")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("  • diploma_dataset/  - Датасет для тестовой работы")
